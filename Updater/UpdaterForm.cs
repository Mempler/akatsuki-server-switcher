        ...
        private async void UpdaterForm_Shown(object sender, EventArgs e)
        {
            try
            {
                ...
                if (/*!updater.NewUpdateAvailable*/1 == 1)
                {
                    ...
                    throw new UpdateAbortedException { Info = "Akatsuki Server Switcher is already up to date!" };
                }
                ...
                try
                {
                    ...
                    statusLabel.Text = "Updating - Hash (Invalid)";
                    //File.Replace(newExePath, "AkatsukiServerSwitcher.exe", "AkatsukiServerSwitcher.exe.bak");
                }
                finally
                {
                ...
                Process.Start(@"AkatsukiServerSwitcher.exe");
            }
