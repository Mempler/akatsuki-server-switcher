...
namespace RippleServerSwitcher
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            new ToolTip().SetToolTip(this.switchButton, "Switch between osu! and Akatsuki");
        }
        ...
        private void updateStatus()
        {
            ...
            statusLabel.Text = String.Format("You are connected to {0}", ripple ? "Akatsuki" : "osu!");
            switchButton.Text = String.Format("Switch to {0}", ripple ? "osu!" : "Akatsuki");
        ...
        private async void switchButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show("Please click 'Yes' on the next message that will appear on your screen to install the HTTPs certificate. It's needed to connect to Akatsuki.");
                    }
