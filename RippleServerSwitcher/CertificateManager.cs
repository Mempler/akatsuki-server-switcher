                ...
                foreach (X509Certificate2 cert in collection)
                    ...
                    catch (CryptographicException)
                    {
                        throw new HumanReadableException(
                            ...
                            "The certificate is needed to connect to Akatsuki through HTTPs. Without it, you won't be able to connect. " +
                            "Click on 'Switch to Akatsuki', then 'Yes' to install the certificate and switch to Akatsuki."
                        );
                    }
            }
            finally
