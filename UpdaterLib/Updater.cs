...
namespace Updater
{
    ...
    {
        public string Endpoint = "https://old.akatsuki.pw/updater.json";
        ...
        public Updater()
        {
            try
            {
                AssemblyVersion = Convert.ToInt32(FileVersionInfo.GetVersionInfo("AkatsukiServerSwitcher.exe").FileVersion.Replace(".", string.Empty));
            }
            catch
            {
                AssemblyVersion = 0;
